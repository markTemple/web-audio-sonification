		    ...
		    <input name="Instrument_Frame_1" type="hidden" value="1" />
		    <input name="instra_groups_2" type="hidden" value="3" />
		    <input name="Instrument_Frame_2" type="hidden" value="28" />
		    <input name="instra_groups_3" type="hidden" value="1" />
		    <input name="Instrument_Frame_3" type="hidden" value="14" />
